...
if (isset($_GET['add_to_cart']) && is_numeric($_GET['add_to_cart'])) {
    ...
    if ($product_result && $product_result->num_rows > 0) {
        ...
        // Chuyển hướng người dùng về trang products1.php sau khi thêm thành công
        ...
        header('Location: products1.php?' . http_build_query($redirect_params));
        exit();
    }
}
...
function buildSortUrl($cn, $new_sort, $current_slug, $current_search) {
    ...
    return 'products1.php?' . http_build_query($params); // Trỏ về products1.php
}
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="products1.php" class="active">Sản phẩm</a></li>
                <li><a href="clothify.php">Về Clothify</a></li>
                <li><a href="contact.php">Liên hệ</a></li>
                <li> <a href="manage_order.php"> Quản Lí Đơn Hàng </a> </li>
    ...
    <section class="main-content-wrapper">
        ...
        <aside class="sidebar-filter">
            ...
            <div class="category-filter-list">
                <a href="products1.php?<?= htmlspecialchars(http_build_query(['search_q' => $search_query, 'sort_order' => $sort_order])) ?>" 
                ...
                <?php if ($categories_result && $categories_result->num_rows > 0): ?>
                    ...
                    <?php while($cat = $categories_result->fetch_assoc()): ?>
                        ...
                        ?>
                        <a href="products1.php?<?= http_build_query($cat_params) ?>" 
        ...
        <main class="product-listing-area">
            ...
            <div class="listing-header">
                ...
                <form method="GET" action="products1.php" class="search-sort-controls">
                    ...
                    <a href="edit-category.php" class="btn-add"> Quản Lí Danh Mục </a>
                        ...
                        <?php while($row = $result->fetch_assoc()): ?>
                            <div class="product">
                                ...
                                <?php 
                                    ...
                                    $cart_link = 'products1.php?' . http_build_query($cart_params); // Trỏ về products1.php
                                ?>
                                <div class="product-actions">
                                    <a href="edit.php?id=<?= $row['id'] ?>" class="btn-edit">Sửa</a>
                                    <a href="delete.php?id=<?= $row['id'] ?>" class="btn-delete" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này?')">Xóa</a>
                                </div>
